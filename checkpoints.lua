...
function checkpoint.latest(opt)
    ...
    local normInfo = nil
    if not paths.filep(paths.concat(opt.resume, latest.normInfo)) then
        print('norm info will be re-computed further')
    else
        normInfo = torch.load(paths.concat(opt.resume, latest.normInfo))
    end
